...
%% Setup Figure
% close all;
fHandle = figure('Position', [650 50  825 875], 'NumberTitle','off','Name', 'Bilat Fig 1' );
ax = [];
...
set(ax(3),'XLim', [-.075 .075], 'YTick', []);
t = title('SPL11 Rip trig LFP');
set(t,'Position', [0 400, 1]);
...
rose(ripPhaseSleep.dPhase, bins, 'Parent', ax(4));
...
t = title('Bilateral Ripple Mean Freq Dist', 'Parent', ax(5));
set(t,'Position', [187.5 225, 1]);
%% Save the figure

save_bilat_figure('figure1', fHandle);
